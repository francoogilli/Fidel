      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7">
        {pricingData.map((pricing) => (
          ...
          >
            ...
            <a
              href="#"
              className="flex justify-center items-center gap-x-1 bg-gradient-to-t from-[#252525] to-[#343434] text-white font-semibold rounded-2xl text-sm px-5 py-2.5 text-center border-4 border-[#FCFCFC] hover:border-[#e5e5e5] transition-all duration-700"
            >
              Elegir
            </a>
          </div>
