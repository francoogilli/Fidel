...
export default function Integration() {
  return (
    <div className="max-w-7xl mb-[24rem] mx-auto">
      ...
      <div className="flex mx-auto justify-center items-center pb-12">
        <h3
      ...
      <div className="grid grid-cols-12 relative gap-x-5">
        ...
        <div className="col-span-6 bg-gradient-to-br from-[#fcfef9] via-[#F8F9FA] to-[#fcfef9] border border-[#e6eee6] rounded-3xl px-6 py-5">
          <h3
            className="font-bold text-[2.5rem] leading-[2.5rem] text-center"
            style={{ fontFamily: "Satoshi" }}
          >
