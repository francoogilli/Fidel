...
export default function Contact() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 max-w-7xl mx-auto px-4 gap-y-5 md:gap-x-5 pt-32">
      ...
      <div className="col-span-7 bg-[#f5f5f541] rounded-3xl px-4 flex flex-col justify-center items-center">
        <div className=" flex bg-[#fafafa] rounded-full pt-5 md:pt-0 px-4 items-center justify-center gap-x-1.5 mr-1.5">
          <img
            src="/fidel1.svg"
