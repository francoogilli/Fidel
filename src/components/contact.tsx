          ...
          <Form className="flex flex-col mx-auto max-w-[45rem] pt-7 justify-center gap-y-5 px-4">
            <div className="flex flex-col">
              ...
              <div className="relative w-full">
                ...
                <input
                  type="text"
                  className="w-full bg-[#F9F9F9] border-2 border-[#F3F3F3] rounded-[.625rem] text-[13px] p-3 lg:pl-12 pl-9 placeholder:text-[#A0A0A0] text-[#3e3e3e] placeholder:text-[13px] placeholder:px-0.5"
                  name="firstname"
            ...
            <div className="flex flex-col">
              ...
              <div className="relative w-full">
                ...
                <textarea
                  rows={4}
                  className="w-full bg-[#F9F9F9] border-2 border-[#F3F3F3] rounded-[.625rem] resize-none text-[13px] p-3 lg:pl-12 pl-9 placeholder:text-[#A0A0A0] text-[#3e3e3e] placeholder:text-[13px] placeholder:px-0.5"
                  name="publicidad"
                  onChange={handleChange}
                  onBlur={handleBlur}
