      ...
      <div className="flex-1  text-center lg:text-left pt-0 md:pt-[2rem]">
        ...
        <div className="lg:px-0 mt-4 mx-auto w-[23rem] md:w-[36rem]">
          ...
          >
            ...
            impulsar la gestión de tu negocio. Potencia tus procesos para llevar
            tu empresa más lejos.
          </h4>
        </div>
        ...
        <div className="mt-6">
          <div className="flex flex-col md:flex-row md:space-x-3 mx-auto lg:mx-0 justify-center lg:justify-start items-center text-center space-y-2 md:space-y-0">
            ...
            <Link to="/plans">
              <button
                className="bg-[#fafafa] tracking-tighter md:tracking-normal text-[#171717] gap-2 justify-center w-auto font-bold py-2.5 px-6 md:px-7 md:py-3 text-base md:text-[15px] rounded-[18px] flex items-center space-x-2 border-4 md:border-[5px] border-[#fafafa] hover:border-[#f6f6f6] transition-all duration-700"
                style={{ fontFamily: "Satoshi" }}
              >
      ...
      <div className="relative flex-1 flex justify-center lg:justify-end items-center">
        ...
        <button className="absolute inset-0 flex justify-center mt-0 md:mt-11 items-center">
          <div className="bg-[#6fff6d] hover:bg-[#43fc40] border-[7px] border-[#dcffdb] hover:border-[#e6ffe6] p-4 rounded-full shadow-xl hover:shadow-2xl duration-500 transition-all">
            <PlayIcon className="size-12 pl-0.5 text-white" />
          </div>
        </button>
      </div>
    </div>
