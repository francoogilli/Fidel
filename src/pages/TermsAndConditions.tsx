export const TermsAndConditions = () => {
    return (
      <div className="bg-white max-w-5xl mx-auto px-4" style={{ fontFamily: 'Outfit Variable' }}>
        <h3 className="text-4xl md:text-6xl font-medium pt-24 justify-center flex pb-2" style={{ fontFamily: 'Outfit Variable' }}>
          Términos & Condiciones
        </h3>
        <div className="pt-2 md:pt-8 text-lg">
          <p className="text-[#242726] pb-12 md:pb-24 font-light text-base flex justify-center">
            Última Actualización: 04 de febrero, 2024
          </p>
  
          <h4 className="font-semibold text-[1.7rem] my-8">1. Introducción:</h4>
          ...
          <h4 className="font-semibold text-[1.7rem] my-8">2. Requisitos para obtener el bono:</h4>
          <p className="text-[#242726] font-light text-base">
          ...
          <h5 className="font-semibold text-[1.5rem] my-8">Ampliación del párrafo anterior:</h5>
          <p className="text-[#242726] font-light text-base">
          ...
          <h4 className="font-semibold text-[1.7rem] my-8">3. Proceso de referencia:</h4>
          <p className="text-[#242726] font-light text-base">
          ...
          <h4 className="font-semibold text-[1.7rem] my-8">4. Entrega del premio:</h4>
          <p className="text-[#242726] font-light text-base">
          ...
          <h4 className="font-semibold text-[1.7rem] my-8">5. Vigencia del acuerdo:</h4>
          <p className="text-[#242726] font-light text-base">
